...
class EnvGame(Game):
    ...
    def __init__(self, ghostAgents, display, rules, layout):
...
class PacmanEnv(gym.Env):
    ...
    def __init__(self, layout, ghosts, display, timeout=30):
        import __main__
    ...
    def reset(self):
        ...
        Returns: observation (object): the initial observation of the
            space.
        """
        self.game = EnvGame(self._ghosts, self._display, self._rules, self._layout)
        self.game.init()
...
if __name__ == '__main__':
    import layout
    medium_layout = layout.getLayout('mediumClassic', percentFood=0.6)
    ghosts = []
    for i in range(2):
