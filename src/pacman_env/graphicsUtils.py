...
def getImage():
    ps = _canvas.postscript(pageanchor='sw',y='0.c',x='0.c')
    return Image.open(io.BytesIO(ps.encode('utf-8')))
    #x=_root_window.winfo_rootx()
    #y=_root_window.winfo_rooty()
    #x1=x+_root_window.winfo_width()
    #y1=y+_root_window.winfo_height()
