...
class PacmanGraphics:
    def __init__(self, zoom=1.0, frameTime=0.0, capture=False, includeInfoPane=True):
        self.have_window = 0
        ...
        self.includeInfoPane = includeInfoPane
    ...
    def make_window(self, width, height):
        (screen_width, screen_height) = self.get_size(width, height)
